		...
		<div class="container">
			<div class="row">
				<div class="col-lg-3 order-2 order-lg-1">
					<div class="filter-widget">
						...
						<ul class="category-menu">
							...
							<li><a href="#">Mouse</a>
								<ul class="sub-menu">
									<li><a href="#">6000 DPI</a></li>
									<li><a href="#">10.000 DPI</a></li>
									<li><a href="#">Gamer Mouse</a></li>
									<li><a href="#">Office Mouse<span>(2)</span></a></li>
								</ul></li>
				...
				<div class="col-lg-9  order-1 order-lg-2 mb-5 mb-lg-0">
					<div class="row">
                        <?php
                            $products=$pdo->query("SELECT * FROM product WHERE pro_vitrin =1 ORDER BY RAND() ");              
